...
{
    public class Databox_personal_rights_info
    {
    ...
    public class Databox_privileges
    {
    ...
    public class Databox_personal_space_info
    {
        public long used_size { get; set; }
        public long total_size { get; set; }

    }
    public class databox : Config<databox>, MagBase
    {
        ...
        public async Task<HttpResult<databox>> get_personal_info(bool redirect = false,string token="")
        {
            var client = new Hclient<databox>();
            var r = await client.PostAsJsonAsync(DriveApi.databox_get_personal_info, new { },null,false,token);
